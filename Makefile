...
SRC			= main.c dda.c render.c init.c move.c texture.c get_tex.c draw_tex.c \
				map_check.c set_player_pos.c file_check.c copy_file_content.c rec_texture.c \
					rec_bg_color.c lib_utils.c lib_utils2.c lib_utils3.c Get_Next_Line/get_next_line.c Get_Next_Line/get_next_line_utils.c
